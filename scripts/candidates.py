...
ELECTION_HASHTAGS = ['#GłosowanieKorespondencyjne', '#WyboryKorespondencyjne', '#PrzełożyćWybory', '#IdziemyNaWybory', '#Wybory2020',
                    '#WyboryPrezydenckie2020', '#WyboryPrezydenckie', '#wybory','#wyPAD2020']
